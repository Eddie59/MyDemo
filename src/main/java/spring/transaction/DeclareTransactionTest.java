...
import spring.transaction.service.declare.DeclareAddressServiceImpl;
...
/**
 * DeclareTransactionTest class
 *
 * @author Administrator
 * @date
 */
public class DeclareTransactionTest {
    ...
    public void DeclareTrunsaction()
    {
        ...
        IAddressService addressService = ctx.getBean("addressService", DeclareAddressServiceImpl.class);
